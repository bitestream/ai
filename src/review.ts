...
const ignoreKeyword = '@biteai: ignore'
...
### Chat with <img src="https://raw.githubusercontent.com/ParryQiu/ai/main/docs/images/CoderabbitIcon.png?s=41&u=fad245b8b4c7254fe63dd4dcd4d662ace122757e&v=4" alt="Image description" width="20" height="20">  BiteAI Bot (\`@biteai\`)
...
- Add \`@biteai: ignore\` anywhere in the PR description to pause further reviews from the bot.
